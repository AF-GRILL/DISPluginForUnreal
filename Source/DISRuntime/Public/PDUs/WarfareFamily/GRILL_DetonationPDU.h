...
struct FDetonationPDU : public FWarfareFamilyPDU
{
	...
	*/
	...
	void SetupFromOpenDIS(DIS::DetonationPdu* DetonationPDUIn)
	{
		...
		//location
		Location[0] = DetonationPDUIn->getLocationInWorldCoordinates().getX();
		Location[1] = DetonationPDUIn->getLocationInWorldCoordinates().getY();
		Location[2] = DetonationPDUIn->getLocationInWorldCoordinates().getZ();

		//locationDouble
		LocationDouble[0] = DetonationPDUIn->getLocationInWorldCoordinates().getX();
		LocationDouble[1] = DetonationPDUIn->getLocationInWorldCoordinates().getY();
		LocationDouble[2] = DetonationPDUIn->getLocationInWorldCoordinates().getZ();
